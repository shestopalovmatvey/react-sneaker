...
export default function Drawer(props) {
  ...
  const finalPrice = props.items.reduce((sum, current) => sum + current.price, 0)
  props.handlerSetPrice(finalPrice)
  return (
    <div
    ...
    >
      <div className={classes.cart}>
        <div className={classes.cart__title}>
          <h2>Корзина</h2>
          <button onClick={props.handlerCartOpen}>
            <svg
              width="32"
              height="32"
              viewBox="0 0 32 32"
